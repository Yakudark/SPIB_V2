...
<div class="bg-white rounded-lg shadow p-6">
    <div class="border-b border-gray-200 mb-4">
        <ul class="flex -mb-px">
            <li class="mr-2">
                <button data-i18n="upcomingInterviewsTitle" onclick="switchTab('upcoming')" class="inline-block p-4 text-blue-600 border-b-2 border-blue-600 rounded-t-lg active" id="upcoming-tab prochEntretien">
                    Prochains Entretiens
                </button>
            </li>
            <li class="mr-2">
                <button data-i18n="interviewHistory" onclick="switchTab('history')" class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-600 hover:border-gray-300" id="history-tab">
    ...
    <!-- Filtres -->
    <div class="mb-4 w-64">
        <label for="filterAgent" data-i18n="filterByAgent" class="block text-sm font-medium text-gray-700">Filtrer par agent</label>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        <th data-i18n="date" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Date</th>
                        <th data-i18n="agent" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Agent</th>
                        <th data-i18n="type" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Type</th>
                        <th data-i18n="with" class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Avec</th>
